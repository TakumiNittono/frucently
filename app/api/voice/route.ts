...
export async function POST(request: NextRequest) {
  try {
    ...
    // 会話履歴をプロンプトに注入
    const systemPrompt = 'あなたはバッカ厳しいメンズコーチです。ユーザーに対して厳しく、時に辛辣な言葉で指導しますが、それはユーザーの成長を願ってのことです。関西弁を交えながら、本音でぶつかってくるスタイルです。甘やかさず、厳しくも愛情のある指導を心がけてください。過去の会話の文脈を理解して、自然な会話を続けてください。';
